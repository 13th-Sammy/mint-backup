...
class Library {
    ...
    public void addBook() {
        ...
        String t=JOptionPane.showInputDialog("Enter Book Name -");
        ...
        for(Book b:BookList.values()) {
            if(b.getTitle().equalsIgnoreCase(t) && b.getAuthor().equalsIgnoreCase(a) && b.getID()!=ID) {
                b.addTotalCopies(1);
                b.addAvailCopies(1);
                JOptionPane.showMessageDialog(null, "Title and Author already exist, added to existing Book ID - " + b.getID());
                return;
            }
            else if(b.getTitle().equalsIgnoreCase(t) && b.getAuthor().equalsIgnoreCase(a) && b.getID()==ID) {
                b.addTotalCopies(1);
                b.addAvailCopies(1);
                JOptionPane.showMessageDialog(null, "Added to existing Book ID - " + b.getID());
                return;
            }
            else if(b.getID()==ID && (!b.getTitle().equalsIgnoreCase(t) || !b.getAuthor().equalsIgnoreCase(a))) {
                JOptionPane.showMessageDialog(null, "Different Books cannot have same Book ID, not added.");
                return;
            }
        }
        ...
        JOptionPane.showMessageDialog(null, "Book Added successfully, Book ID - " + book.getID());
    }
