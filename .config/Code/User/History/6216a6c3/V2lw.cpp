...
int main()
{
    ...
    background2.setTexture(backgroundTexture); //create two background sprites
    ...
    while (window.isOpen() == true)
    {
        ...
        background1.move(-0.5, 0); //background moves
        background2.move(-0.5, 0);
        if(background1.getPosition().x < -1600)
            background1.setPosition(1600,0);
