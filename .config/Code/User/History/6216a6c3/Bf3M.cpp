...
int main()
{
    ...
    while (window.isOpen() == true)
    {
        ...
        /*if(tpipe1.getPosition().x <= -tpipe1.getGlobalBounds().width)
            tpipe1.setPosition(tpipe2.getPosition().x+600, tpipe1.getPosition().y);
        if(tpipe2.getPosition().x <= -tpipe2.getGlobalBounds().width)
            tpipe2.setPosition(tpipe1.getPosition().x+600, tpipe2.getPosition().y);
        if(bpipe1.getPosition().x <= -bpipe1.getGlobalBounds().width)
            bpipe1.setPosition(bpipe2.getPosition().x+600, bpipe1.getPosition().y);
        if(bpipe2.getPosition().x <= -bpipe2.getGlobalBounds().width)
            bpipe2.setPosition(bpipe1.getPosition().x+600, bpipe2.getPosition().y);*/
        if(tpipe1.getPosition().x <= -tpipe1.getGlobalBounds().width)
        {
