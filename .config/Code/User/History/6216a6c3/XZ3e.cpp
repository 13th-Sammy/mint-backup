...
int main()
{
    ...
    bpipe2.setPosition(2200, 900 - bpipe1.getGlobalBounds().height);
    ...
    while (window.isOpen() == true)
    {
        ...
        if(tpipe1.getPosition().x == -tpipe1.getGlobalBounds().width)
            tpipe1.setPosition(1600, tpipe1.getPosition().y);
        if(tpipe2.getPosition().x == -tpipe2.getGlobalBounds().width)
            tpipe1.setPosition(2200, tpipe2.getPosition().y);
        if(bpipe1.getPosition().x == -bpipe1.getGlobalBounds().width)
            bpipe1.setPosition(1600, bpipe1.getPosition().y);
        if(bpipe2.getPosition().x == -bpipe1.getGlobalBounds().width)
            bpipe2.setPosition(2200, bpipe1.getPosition().y);
