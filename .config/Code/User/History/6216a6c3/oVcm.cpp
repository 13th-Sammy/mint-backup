        ...
        if(tpipe1.getPosition().x <= -tpipe1.getGlobalBounds().width)
{
    ...
    tpipe1.setPosition(newX, tpipe1.getPosition().y);
    bpipe1.setPosition(newX, bpipe1.getPosition().y); // Keep bottom pipe aligned
}
if(tpipe2.getPosition().x <= -tpipe2.getGlobalBounds().width)
{
    float newX = std::max(tpipe1.getPosition().x, 1600.0f) + 600;
    tpipe2.setPosition(newX, tpipe2.getPosition().y);
    bpipe2.setPosition(newX, bpipe2.getPosition().y); // Keep bottom pipe aligned
}
